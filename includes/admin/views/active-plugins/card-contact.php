            ...
            <div class="im-card im-card-contact">
                ...
                <div class="im-card-header im-card-header-contact">
                    <h3>
                        ...
                        <?php echo esc_html__('ارتباط با ما', 'talashnet-external-request-blocker'); ?>
                    </h3>
                </div>
                ...
                <div class="im-card-body">
                    ...
                    <div class="im-contact-company">
                        ...
                        <h4 class="im-company-name">
                            <?php echo esc_html__('تلاش نت', 'talashnet-external-request-blocker'); ?>
                        </h4>

                        <p class="im-company-tagline">
                            <?php echo esc_html__('راهکاری جامع در فناوری اطلاعات', 'talashnet-external-request-blocker'); ?>
                        </p>
                    </div>

                    <div class="im-contact-links">

                        <a href="https://talashnet.com"
                            target="_blank"
                            class="im-contact-link">
                            <span class="dashicons dashicons-admin-site"></span>
                            <?php echo esc_html__('وب سایت', 'talashnet-external-request-blocker'); ?>
                        </a>

                        <a href="mailto:info@talashnet.com"
                            class="im-contact-link">
                            <span class="dashicons dashicons-email-alt"></span>
                            <?php echo esc_html__('ایمیل', 'talashnet-external-request-blocker'); ?>
                        </a>

                        <a href="https://talashnet.com/contactus"
                            target="_blank"
                            class="im-contact-link">
